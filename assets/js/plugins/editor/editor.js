(function( $ ){
	...
	var methods = {
		...
		imageWidget: function () {
		    //Class for Widget Modal Handel The Image Select
		    var row = $('<div/>', {
		        "class": "row"
		    }).append($('<div/>', {
		        id: "imgErrMsg"
        ...
        //CAUTION sensitive stuff Starts********************************************************


		imageoldWidget: function(){
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
							 ...
							 'image_size': {
							     ...
							     "custom": function (imagesizes) {
							         var editor = $('.Editor-editor');
							         var img = editor.find('img')							         
							         img.css({'width' : imagesizes , 'height' : imagesizes});;
							     }
							 },
						...
						'insert_table'	: { "modal": true,
						   ...
						   'outdent'	: { "text": "Outdent", 
							...
							'preview': {
							    ...
							    "tooltip": "Preview",
							    "commandname": null,							    
							    "modalHeader": "Theme Preview",							    
							    "modalBody":methods.getPreview.apply(this),
							    "params": { "obj": null },							    
							    "beforeLoad": function () {
							        var design = $('.Editor-editor').html();
							        $("#layoutframe").contents().find("#previewpage").html(design);
							    },
							    "onSave": function () {							      
							        $("#Preview").modal("hide");
							        $(this).data("editor").focus();
			...
			var menuGroups = {'texteffects' : ['bold', 'italics', 'underline', 'color'],
							  ...
							  'fonteffects': ['fonts', 'styles', 'font_size' , 'image_size'],
							  'actions' : ['undo', 'redo'],
							  'insertoptions' : ['insert_link', 'unlink', 'insert_img', 'insert_table'],
							  'extraeffects' : ['strikeout', 'hr_line', 'splchars'],
							  'advancedoptions' : ['print', 'rm_format', 'select_all', 'source' , 'preview'],
